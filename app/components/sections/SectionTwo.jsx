          ...
          <div className='flex justify-center content-center align-middle relative h-[500px]'>
            <div className='flex justify-center content-center align-middle gap-0 md:gap-4 lg:gap-6'>
              ...
              <div className=' mt-5 flex flex-col align-middle justify-start py-5'>
                <div className='pr-5'>
                  <h4 className='text-lg md:text-2xl lg:text-3xl font-main_light'>
                    {text.subHeader}
                  </h4>
                </div>
                <div className='flex flex-col'>
                  <div className='-mr-8 '>
                    <LettersAnimation key={text.header} className='mt-2 mr-2 text-3xl md:text-6xl lg:text-6xl font-main_black max-w-full' text={`${text.header}`} tag='h3'>
                      ...
                      >
                        <AnimatePresence>
                          <motion.em
                            className='inline-block relative w-[max-content] self-baseline mt-2 mr-2 text-3xl md:text-6xl lg:text-6xl font-main_black '
                            variants={variants}
                            initial='initial'
                            animate='enter'
                            exit='exit'
