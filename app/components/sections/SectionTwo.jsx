          ...
          <motion.div className='  '>
            <div>
              <div className='flex gap-12'>
                <div className='bg- flex justify-center content-center  align-middle relative h-[400px]'>
                    ...
                    <div className='bg-red- py-5'>
                      <div className=' mt-5 flex flex-col align-middle justify-start'>
                        ...
                        <motion.div>
                          ...
                          <div className='grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-20 max-h-[64px] mt-8'>
                  ...
                  <div className='bg-yellow- flex absolute -z-30 left-5 top-0'>
                    <VerticalLine width={42} heigth={400} />
                  </div>
                </div>
              </div>
            </div>
