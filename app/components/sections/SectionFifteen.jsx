    ...
    <div className='px-2 md:px-14 lg:px-32 w-full relative'>
      <div className=' flex flex-col align-middle content-center justify-center pb-64 pt-24 md:pb-72 md:pt-32 lg:pb-80 lg:pt-36'>
        <div className='items-center align-middle content-center justify-center flex'>
          <p className='header-invite  text-black  text-5xl md:text-7xl lg:text-8xl text-center font-main_outline inline-block relative  self-baseline'>
            {text.header} <br />
            <AnimatePresence>
              <motion.span
                variants={variants}
                ...
                className='invite-place text-6xl md:text-8xl lg:text-9xl inline-block relative w-[max-content] self-baseline overflow-hidden min-h-[60px] text-center'
              >
                <motion.strong
                  className='invite-place text-6xl md:text-8xl lg:text-9xl font-main_bold inline-block relative w-[max-content] self-baseline mt-2 px-2'
                  variants={variants}
                  initial='initial'
                  animate='enter'
                  exit='exit'
