export default function ButtonApps ({ type, text, url }) {
  if (type === 'apple') {
    return (
      <button className='bg-tangle-oxford-blue flex px-7 md:px-14 py-3  rounded-lg'>
        ...
        <a target='_self' href={url || '#'} rel='noopener noreferrer' className='justify-self-center self-center place-content-center pl-4 text-sm '>
          {text}
        </a>
      </button>
    )
    ...
    return (
      <button className='bg-tangle-oxford-blue flex px-7 md:px-14 py-3 rounded-lg self-start'>
        <div className='flex self-center'>
