...
export const Ellipse = ({ icon }) => {
  ...
  if (icon === 'zap') {
    return (
      <motion.div variants={svgVariants} initial='hidden' animate='visible' className='justify-self-center self-center place-content-center w-fit flex content-center p-3' height='60' width='60' style={{ background: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 173, 228, 0.8) 0%, rgba(0, 173, 228, 0) 100%)' }}>
        <motion.svg variants={svgVariants} initial='hidden' animate='visible' width='18' height='20' viewBox='0 0 18 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    return (
      <div className='w-fit flex content-center p-3' height='60' width='60' style={{ background: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 173, 228, 0.8) 0%, rgba(0, 173, 228, 0) 100%)' }}>
    ...
    <svg height='60' width='60' style={{ background: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 173, 228, 0.8) 0%, rgba(0, 173, 228, 0) 100%)' }}>
