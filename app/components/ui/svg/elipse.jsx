...
export const Ellipse = ({ icon }) => {
  ...
  if (icon === 'zap') {
    return (
      <motion.div variants={svgVariants} initial='hidden' animate='visible' className='self-center w-fit flex p-3' height='60' width='60' style={{ background: 'radial-gradient(50% 50% at 50% 50%, rgba(0, 173, 228, 0.8) 0%, rgba(0, 173, 228, 0) 100%)' }}>
