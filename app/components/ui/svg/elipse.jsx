...
export const Ellipse = ({ icon, color }) => {
  if (icon === 'zap') {
    ...
    return (
      <motion.div variants={svgVariants} initial='hidden' animate='visible' className='self-center w-fit flex p-3' height='60' width='60' style={{ background: `radial-gradient(50% 50% at 50% 50%, ${color} 0%, rgba(0, 173, 228, 0) 100%)` }}>
        <motion.svg variants={svgVariants} initial='hidden' animate='visible' width='18' height='18' viewBox='1 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <g clipPath='url(#clip0_1439_8962)'>
            <motion.path variants={pathVariants} d='M10.0001 18.3333C14.6025 18.3333 18.3334 14.6023 18.3334 9.99996C18.3334 5.39759 14.6025 1.66663 10.0001 1.66663C5.39771 1.66663 1.66675 5.39759 1.66675 9.99996C1.66675 14.6023 5.39771 18.3333 10.0001 18.3333Z' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M6.66675 12.5H13.3334' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M7.5 7.5H7.50833' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M12.5 7.5H12.5083' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
          </g>
          <defs>
    ...
    return (
      <motion.div variants={svgVariants} initial='hidden' animate='visible' className='self-center w-fit flex p-3' height='60' width='60' style={{ background: `radial-gradient(50% 50% at 50% 50%, ${color} 0%, rgba(0, 173, 228, 0) 100%)` }}>
        <motion.svg variants={svgVariants} initial='hidden' animate='visible' width='18' height='18' viewBox='-1 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <g clipPath='url(#clip0_1439_8969)'>
            <motion.path variants={pathVariants} d='M9.99996 18.3334C14.6023 18.3334 18.3333 14.6025 18.3333 10.0001C18.3333 5.39771 14.6023 1.66675 9.99996 1.66675C5.39759 1.66675 1.66663 5.39771 1.66663 10.0001C1.66663 14.6025 5.39759 18.3334 9.99996 18.3334Z' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M6.66663 11.6667C6.66663 11.6667 7.91663 13.3334 9.99996 13.3334C12.0833 13.3334 13.3333 11.6667 13.3333 11.6667' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M7.5 7.5H7.50833' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M12.5 7.5H12.5083' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
          </g>
          <defs>
    ...
    return (
      <motion.div variants={svgVariants} initial='hidden' animate='visible' className='self-center w-fit flex p-3' height='60' width='60' style={{ background: `radial-gradient(50% 50% at 50% 50%, ${color} 0%, rgba(0, 173, 228, 0) 100%)` }}>
        <motion.svg variants={svgVariants} initial='hidden' animate='visible' width='18' height='18' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <g clipPath='url(#clip0_1439_8976)'>
            <motion.path variants={pathVariants} d='M15.1621 6.70264C16.5428 6.70264 17.6621 5.58335 17.6621 4.20264C17.6621 2.82192 16.5428 1.70264 15.1621 1.70264C13.7814 1.70264 12.6621 2.82192 12.6621 4.20264C12.6621 5.58335 13.7814 6.70264 15.1621 6.70264Z' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M5.16211 12.5361C6.54282 12.5361 7.66211 11.4168 7.66211 10.0361C7.66211 8.65542 6.54282 7.53613 5.16211 7.53613C3.7814 7.53613 2.66211 8.65542 2.66211 10.0361C2.66211 11.4168 3.7814 12.5361 5.16211 12.5361Z' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M15.1621 18.3696C16.5428 18.3696 17.6621 17.2503 17.6621 15.8696C17.6621 14.4889 16.5428 13.3696 15.1621 13.3696C13.7814 13.3696 12.6621 14.4889 12.6621 15.8696C12.6621 17.2503 13.7814 18.3696 15.1621 18.3696Z' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M7.32056 11.2944L13.0122 14.6111' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
            <motion.path variants={pathVariants} d='M13.0039 5.46094L7.32056 8.7776' stroke='white' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
          </g>
          <defs>
